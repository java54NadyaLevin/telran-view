...
//	@Test
//	void getLongTest() {
//		Long longNumber = io.readLong("Enter a number", "Enter a number");
//		io.writeLine(longNumber);
//	}

//	@Test
//	void getDoubleTest() {
//		Double doubleNumber = io.readDouble("Enter a number", "Enter a number");
...
//	}
	...
	void readNumberRangeTest() {
		Double doubleNumber = io.readNumberRange("Enter a number", "Enter a -1 <= number < 100 ", -1, 100);
		io.writeLine(doubleNumber);
	}
